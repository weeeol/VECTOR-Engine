<div align="center">
  ...
  <p align="center">
    ...
    <a href="https://box2d.org/"><img src="https://img.shields.io/badge/Box2D-v3.0+-green?style=for-the-badge&logo=box2d" alt="Box2D"></a>
...
**VECTOR** is a custom hardware-accelerated 2D C++ game engine built from scratch using **SDL3**. It is compiled as a standalone static library (`libVECTOR.a`) and includes a fully functional Pong game that demonstrates the engine's incredible capabilities.
...
- 🕹️ **Game Modes**: Play in standard "5 Point Mode" or "Endless Mode".
...
- ⏱️ **Fixed Time-Step**: Physics run at a constant rate regardless of frame rate.
...
This engine uses a **universal CMake configuration**. It first attempts to find SDL3 using standard `find_package` (ideal for `vcpkg` or macOS/Linux package managers), and gracefully falls back to `pkg-config` (ideal for MSYS2 on Windows).
