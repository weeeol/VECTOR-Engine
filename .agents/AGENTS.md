...
- **Vulkan and DX12 are the Primary Focus**: Going forward, Vulkan and DX12 development is the primary focus and OpenGL is considered deprecated. When building new rendering features, prioritize the Vulkan and DX12 backend and do not spend effort maintaining OpenGL unless explicitly requested.
