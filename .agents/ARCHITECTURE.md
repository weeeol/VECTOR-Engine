...
│   │   ├── Core/           # App Loop, Logger, SceneManager, ResourceManager
│   │   ├── ECS/            # Custom Entity-Component System (Registry, Components)
│   │   ├── Events/         # EventBus for decoupled messaging
│   │   ├── Graphics/       # OpenGL 3D Renderer, Shader, Mesh, Texture2D, UI Text Rendering
│   │   ├── Input/          # Keyboard/Mouse state tracking (Relative mouse mode)
│   │   ├── Math/           # GLM math integration
│   │   ├── Physics/        # BulletPhysicsSystem for 3D RigidBodies and Collisions
│   │   └── UI/             # UIManager, UIElement, UIButton, UISlider
│   └── Game/               # Game-Specific Implementation
│       ├── Core/           # Game application logic (PongGame legacy name), GameComponents
│       ├── Events/         # Game-specific events (ScoreEvent, CollisionEvent)
│       ├── Scenes/         # MainMenuScene, GameplayScene
│       └── Systems/        # Modular ECS Systems (CameraSystem, ShootingSystem)
```
